    ...
    private bool isValidSubmit()
    {
        ...
        if(RadioButtonList1.SelectedItem.Text != "Net Banking")
        {
            ...
            if (RadioButtonList2.SelectedItem.Text == "Maestro")
            {
                ...
                if (TextBox11.Text.Length != 4 || TextBox12.Text.Length != 4 || TextBox13.Text.Length != 4 || TextBox14.Text.Length != 4 || TextBox15.Text.Length != 3)
                {
                    lblErrorMessage.Text = "Please Enter Card Number";
                    return false;
                } 
            ...
            if (RadioButtonList2.SelectedItem.Text != "Maestro")
            {
                if (TextBox11.Text.Trim() == "" || TextBox12.Text.Trim() == "" || TextBox13.Text.Trim() == "" || TextBox14.Text.Trim() == "")
                {
                    lblErrorMessage.Text = "Please Enter Card Number";
                    return false;
                }
            ...
            //else if (DropDownList2.SelectedItem.Text != System.DateTime.Now.Month.ToString())
            //{
            //    lblErrorMessage.Text = "Please Select a Month";
            //    return false;
            //}
